...
const operatingModel = [
  'Weekly performance war-room with clear owners.',
  'Single source of truth for media, affiliate, and finance.',
  'Scenario planning for aggressive and conservative growth.',
]
